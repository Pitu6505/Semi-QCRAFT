...
# 1. Definimos tu circuito exactamente como lo pasaste
# (Nota: He añadido creg_c al constructor de QuantumCircuit por buenas prácticas de Qiskit 1.0+)
...
# 2. Instanciamos el compresor (sin mapa físico por ahora para ver la compresión pura)
compressor = AdvancedTopologyCompressor()

print("--- CIRCUITO ORIGINAL ---")
print(circuit)

print("--- INICIANDO OPTIMIZACIÓN DEL CIRCUITO DE 20 QUBITS ---")
circuito_optimizado = compressor.compress_and_map(circuit)
